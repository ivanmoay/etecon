...
<head>
    ...
    <title>Hospice MD Initial Recert Order</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="wrapper">
        ...
        <hr>
        <p class="bg-primary"><b>&nbsp; Is the patient DNR </b>("Do Not Resuscitate") <input type="checkbox"> Yes <input type="checkbox"> No</p>
        <hr>
        <style>
